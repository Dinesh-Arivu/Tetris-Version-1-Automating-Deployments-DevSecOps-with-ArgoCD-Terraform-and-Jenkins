pipeline{
    ...
    stages {
        ...
        stage('Checkout from Git'){
            steps{
                git branch: 'main', url: 'https://github.com/Dinesh-Arivu/Tetris-Version-1-Automating-Deployments-DevSecOps-with-ArgoCD-Terraform-and-Jenkins.git'
            }
        }
            ...
            steps{
                script{
                   withDockerRegistry(credentialsId: 'docker', toolName: 'docker'){
                       ...
                       sh "docker tag tetrisv1 dinesh1097/tetrisv1:latest "
                       sh "docker push dinesh1097/tetrisv1:latest "
                    }
                }
            }
        }
            ...
            steps {
                script {
                    withCredentials([string(credentialsId: 'github', variable: 'GITHUB_TOKEN')]) {
                       NEW_IMAGE_NAME = "dinesh1097/tetrisv1:latest"   
